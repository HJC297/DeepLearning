...
####load data####
train_dat_0_all = datasets.MNIST(data_dir, download=True, train=True, transform=transforms_0)
train_dat_1_all = datasets.MNIST(data_dir, train=True, transform=transforms_1)
train_dat_0, val_dat_0 = random_split(train_dat_0_all, [54000, 6000]) ##54000,6000
test_dat_0 = datasets.MNIST(data_dir, train=False, transform=transforms_0) ##10000


train_loader_0 = DataLoader(train_dat_0, batch_size = 64, shuffle=True) ##844
val_loader_0 = DataLoader(val_dat_0, batch_size=1000, shuffle=False) ##6
test_loader_0 = DataLoader(test_dat_0, batch_size=1000, shuffle=False) ##10

train_dat_1, val_dat_1 = random_split(train_dat_1_all, [54000, 6000])
test_dat_1 = datasets.MNIST(data_dir, train=False, transform=transforms_1) #10000

train_loader_1 = DataLoader(train_dat_1, batch_size=64, shuffle=True) #844
val_loader_1 = DataLoader(val_dat_1, batch_size=1000, shuffle=False)  #6
test_loader_1 = DataLoader(test_dat_1, batch_size=1000, shuffle=False) #10
